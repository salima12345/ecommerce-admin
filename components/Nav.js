...
function Nav({show}) {
    ...
    const activeLink=inactiveLink+ ' bg-bgGray text-black  font-bold rounded-l-lg'
    ...
    <aside className={(show?'left-0':'-left-full')+" top-0 text-white  p-4  pr-0 fixed w-full  bg-black h-screen md:w-1/6 md:static  transition-all"}>
